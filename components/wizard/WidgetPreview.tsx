  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="pb-4 border-b mb-4">
        <h2 className="text-xl font-bold mb-1">Preview Your Widget</h2>
      ...
      <div className="flex-1 grid grid-cols-2 gap-6 overflow-hidden">
        ...
        <div className="flex flex-col border rounded-lg overflow-hidden">
          ...
          <div className="flex items-center justify-between p-3 border-b bg-muted/30">
            <h3 className="text-sm font-semibold">Widget Schema</h3>
            <button
      ...
      <div className="flex items-center justify-between pt-4 border-t mt-4">
        ...
        <button
          ...
          disabled={isDeploying}
          className={cn(
            'px-6 py-2.5 rounded-md font-semibold transition-all',
...
function SchemaEditorModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-background border rounded-lg shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col">
        {/* Modal header */}
        <div className="flex items-center justify-between p-4 border-b">
          <div>
            <h3 className="text-lg font-bold">Edit Widget Schema</h3>
            <p className="text-sm text-muted-foreground">
        ...
        <div className="flex-1 overflow-hidden p-4">
          <textarea
            ...
            className={cn(
              'w-full h-full font-mono text-sm p-4 border rounded-md',
